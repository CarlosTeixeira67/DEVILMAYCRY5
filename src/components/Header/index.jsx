...
import image from '../../assets/devil-may-cry-5-logo-11.png'
import image2 from '../../assets/classificacao-16-anos-logo-1.png'
            ...
            <div className='flex justify-around items-center p-36 flex-col md:flex-row sm:text-center sm:gap-6 sm:text-sm scrol min-[320px]:p-0 min-[320px]:gap-6'>
              <div className=''>
                ...
                <h2 className='text-gray-100 text-xl font-bold'></h2>
                 <FaCircle /> Data de lançamento do jogo, dia 08/03/2019
                </div>
                <h1 className='text-gray-100 text-9xl font-bold mb-3 lg:text-9xl md:text-6xl'>Devil May <br /> Cry 5</h1>
                <p className='text-gray-100 text-lg font-bold mb-8'>Trio de protagonistas, Dante, Nero e V, juntam suas habilidades únicas para enfrentar as ameaças demoníacas <br /> e desvendar os segredos do misterioso poder demoníaco <br />que assola o mundo em Devil May Cry 5.</p>
                <button className='text-black text-xl font-bold border border-none bg-white p-3 mr-3 cursor-pointer'>R$ 249,90</button>
              ...
              <div>
                ...
                <div className='flex items-center lg:justify-center sm:mt-6 sm:justify-center'>
                  ...
                  <div> <h2 className='text-gray-100 text-lg font-bold sm:text-sm'>Linguagem Imprópria, Violência Extrema</h2></div>
                </div>
              </div>
            </div>
          </section>
